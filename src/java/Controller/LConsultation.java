...
public class LConsultation {
    ...
    public static List<Consultation> getConsultation() throws SQLException {
    ...
    public static boolean addConsultation(int idpet, String date, String reason, String diagnosis, String treatment, String observation) {
        ConexionDB conn = new ConexionDB();
    ...
    public static boolean updateConsultation(int idcons, int idpet, String date, String reason, String diagnosis, String treatment, String observation) {
        boolean success = false;
        ConexionDB conn = new ConexionDB();
        try {
            //Llamada a la funcion
    ...
    public static boolean deleteConsultation(int idcons) {
        boolean success = false;
        ConexionDB conn = new ConexionDB();
        try {
            //Llamada a la funcion
