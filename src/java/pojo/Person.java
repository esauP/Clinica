...
public class Person  implements java.io.Serializable {
     ...
     private Set dateses = new HashSet(0);
    ...
    public Person(String idperson, String namePer, String address, String phone, String email, String password, Integer role, Set petses, Set bills, Set dateses) {
       this.idperson = idperson;
       this.namePer = namePer;
    ...
    public Set getDateses() {
        return this.dateses;
    }
    
    public void setDateses(Set dateses) {
        this.dateses = dateses;
    }
